...
public class DBService {
    ...
    public void instanciaDB(){
        ...
        Chamado ch2 = new Chamado(null, Prioridade.ALTA, Status.ENCERRADO,"Chamado 02","Segundo chamado",tec1,cli1);
        Chamado ch3 = new Chamado(null, Prioridade.ALTA, Status.ABERTO,"Chamado 03","Terceiro chamado",tec1,cli1);
        Chamado ch4 = new Chamado(null, Prioridade.BAIXA, Status.ABERTO,"Chamado 04","Quarto chamado",tec1,cli1);
